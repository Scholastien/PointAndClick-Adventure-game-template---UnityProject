...
////// Lighting:
////// Emissive:
                float4 node_8184 = _Time;
                float2 node_6403 = (i.uv0+(objPos.r+objPos.g+objPos.b));
                float2 node_8866 = (node_6403+node_8184.g*float2(0.124,0.1));
                float4 node_103 = tex2D(_Wind,TRANSFORM_TEX(node_8866, _Wind));
                float2 node_955 = (node_6403+node_8184.g*float2(0.163,0.1323));
                ...
                float2 node_78 = ((node_6403+node_8184.g*float2(0.0453,0.0339))*3.0+0.0);
                float4 node_7628 = tex2D(_Wind,TRANSFORM_TEX(node_78, _Wind));
                float3 emissive = saturate((1.0-(1.0-lerp(sceneColor.rgb,lerp(float3(1,1,1),_Clovers_var.rgb,saturate(((i.posWorld.r*0.05+0.0)+1.7))),saturate((_Clovers_var.a*1.3+0.0))))*(1.0-(_CloversGlow_var.rgb*(node_7628.r*1.0+0.0)*float3(0.3529412,0.8661259,1)*2.0))));
