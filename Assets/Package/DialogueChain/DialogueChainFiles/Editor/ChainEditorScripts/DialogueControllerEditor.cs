...
public class DialogueControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        dController.transparentBg = (Sprite)EditorGUILayout.ObjectField("Transparent Bg", dController.transparentBg, typeof(Sprite), false);
        dController.matteBlack = (Sprite)EditorGUILayout.ObjectField("matteBlack Bg", dController.matteBlack, typeof(Sprite), false);
        dController.blurryMaterial = (Material)EditorGUILayout.ObjectField("Blurry material", dController.blurryMaterial, typeof(Material), false);
        ...
        else
        {
            ...
            if (GUILayout.Button("Apply"))
            {
                ...
                {
                    PrefabUtility.ReplacePrefab(dButtons[0], PrefabUtility.GetCorrespondingObjectFromSource(dButtons[0]), ReplacePrefabOptions.ConnectToPrefab);
                ...
                PrefabUtility.ReplacePrefab(editingContainer.container, PrefabUtility.GetCorrespondingObjectFromSource(editingContainer.container), ReplacePrefabOptions.ConnectToPrefab);
                if (cType.ToString().Contains("Input") || cType.ToString().Contains("input"))
                {
